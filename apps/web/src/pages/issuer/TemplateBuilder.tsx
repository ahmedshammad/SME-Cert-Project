...
import {
  Plus, FileText, Edit, Eye, GraduationCap, Scroll, Briefcase,
    ...
    <div className="space-y-6">
        ...
        <Card className="border-green-200 bg-green-50">
          <CardContent className="flex items-center gap-3 py-3">
            ...
            <p className="text-sm text-green-800">
              Template "{clonedNotice}" created successfully!
            </p>
          </CardContent>
        </Card>
      )}
      ...
      <div>
        ...
        {isLoading ? (
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {(templates || []).map((template: { id: string; name: string; description?: string; status?: string; _count?: { certificates: number } }) => (
                ...
                <CardContent>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-muted-foreground">
                      {template._count?.certificates || 0} certificates
                    </span>
